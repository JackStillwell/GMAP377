...
namespace UnityEditor.PostProcessing
{
    public class ParadeMonitor : PostProcessingMonitor
    {
        ...
        public override void OnMonitorSettings()
        {
            ...
            var exposure = m_MonitorSettings.paradeExposure;
        ...
        public override void OnFrameData(RenderTexture source)
        {
            ...
            var ratio = source.width / (float) source.height / 3f;
            var h = 384;
        ...
        private void ComputeWaveform(RenderTexture source)
        {
            ...
            if (m_Material == null)
                m_Material =
                    new Material(Shader.Find("Hidden/Post FX/Monitors/Parade Render")) {hideFlags = HideFlags.DontSave};
